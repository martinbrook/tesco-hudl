...
extern int is_find_battery_low_logo;

const struct linux_logo * __init_refok fb_find_battery_low_logo(int depth)
{
    struct linux_logo *logo = NULL;
	const struct linux_logo *m_logo = NULL;
	
	logo = &logo_battery_low_clut224;
...
const struct linux_logo * __init_refok fb_find_logo(int depth)
{
	...
	if(is_find_battery_low_logo)
		return fb_find_battery_low_logo(depth);
...
#ifdef CONFIG_LOGO_PHARAOH_CLUT224
                logo = &logo_pharaoh_clut224;
#endif
